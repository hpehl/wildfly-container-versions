...
lazy_static! {
    ...
    pub static ref VERSIONS: BTreeMap<u16, WildFlyContainer> = {
        ...
        m.insert(identifier(37, 0), WildFlyContainer::new(Version::new(37, 0, 0), Version::new(29, 0, 0), "Final-jdk21", "quay.io/wildfly/wildfly", vec!["linux/amd64", "linux/arm64", "linux/s390x", "linux/ppc64le"]));
        // @formatter:on
        m
    };
}
